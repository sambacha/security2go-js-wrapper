...
async function sign(web3, rawTx, secondTx) {
  ...
  do {
    ...
    web3.eth.accounts
      .recoverTransaction(toHex(serializedTx))
      .toLocaleLowerCase() !== address
  );
...
const rawTxOpen = {
  ...
  value: 0,
  data:
    "0x0905186e00000000000000000000000001019e15b7beef611ac4659e7acdc272c4d90afa00000000000000000000000000000000000000000000000000000a86cc92e3da",
  gasLimit: "0x100000",
};
...
const rawTxClose = {
  ...
  value: 0,
  data:
    "0x9abe837900000000000000000000000001019e15b7beef611ac4659e7acdc272c4d90afa",
  gasLimit: "0x100000",
};
